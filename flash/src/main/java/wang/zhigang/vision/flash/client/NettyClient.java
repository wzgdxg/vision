 ...
 *    https://kada.hhdd.com/
 *
 *    Package:     wang.zhigang.vision.flash.client
 *
...
import wang.zhigang.vision.flash.handler.client.ClientHandler;
...
public class NettyClient {
    ...
    public static void main(String[] args) {
        ...
        bootstrap.group(new NioEventLoopGroup()).channel(NioSocketChannel.class)
                ...
                .attr(CLIENT_NAME_KEY, "clientSay")
